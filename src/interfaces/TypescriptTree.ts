...
import { TypescriptTreeConstDeclaration } from "./TypescriptTreeConstDeclaration.ts";
...
export interface TypescriptTree {
  ...
  /**
   * An array of const declarations;
   */
  constDeclarations: TypescriptTreeConstDeclaration[];
}
